 ...
 */
    ...
    class mengajarPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Mengajar');
            $this->SetMenuLabel('Mengajar');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('idajar', true, true, true),
                    new StringField('nip'),
                    new StringField('kelas'),
                    new StringField('pel'),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'idajar', 'idajar', 'Idajar'),
        ...
        {
            $main_editor = new TextEdit('idajar_edit');
        ...
        {
            //
            // View column for idajar field
            //
            $column = new NumberViewColumn('idajar', 'idajar', 'Idajar', $this->dataset);
    ...
    try
    {
        $Page = new mengajarPage("mengajar", "mengajar.php", GetCurrentUserPermissionsForPage("mengajar"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("mengajar"));
