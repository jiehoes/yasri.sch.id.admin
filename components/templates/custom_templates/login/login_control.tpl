<div class="well pgui-login">
    ...
    <p class="text-center"><img class="pgui-login-avatar" src="components/templates/custom_templates/assets/img/login_avatar.png" alt="User avatar" /></p>
    <center><h3>ADMINISTRATOR <BR>SMK YASRI</h3></center>
