...
<head>
    ...
    <link rel="icon" href="components/templates/custom_templates/assets/img/favicon.ico" type="image/x-icon"/>
    <link rel="shortcut icon" href="components/templates/custom_templates/assets/img/favicon.ico" type="image/x-icon"/>
    {if !GetOfflineMode()}
