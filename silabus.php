 ...
 */
    ...
    class silabusPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Silabus');
            $this->SetMenuLabel('Silabus');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextAreaEdit('ket_edit', 50, 8);
    ...
    try
    {
        $Page = new silabusPage("silabus", "silabus.php", GetCurrentUserPermissionsForPage("silabus"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("silabus"));
